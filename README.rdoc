...
*This is a work in progress*, that is based on @wireframe's[http://github.com/wireframe] work. I refactored his code to work with default_scope rather than the 
